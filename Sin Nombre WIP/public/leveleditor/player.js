function Player(x,y){
	...
	this.breakStone = function() {
		// TODO
		// Check this.dir and break stone on front.
		// Stone breaking progress is random, so you can have a Lucky Hit.
		// Lucky Hits can give you special items.
		// When the stone breaks you get materials.
		breakForce=0.5;
	...
	this.show = function(){
		image(dayTime ? this.image : this.nightImage,this.x,this.y,32,32,this.dir,0,32,32);
	}
}